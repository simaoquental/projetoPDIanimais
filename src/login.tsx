  ...
  return (
    <div className="min-h-screen w-full bg-[#f8fafc] flex flex-col items-center pt-12 px-6">
          ...
          <div className="bg-white rounded-[2.5rem] shadow-2xl w-full max-w-[420px] p-10 relative">
            ...
            {passo === 'sucesso' && (
              <div className="text-center py-4">
                ...
                <p className="text-slate-500 text-sm font-medium leading-relaxed">A sua palavra-passe foi alterada com sucesso. O modal vai fechar automaticamente.</p>
              </div>
            )}
      ...
      <div className="mt-8 text-slate-500 font-medium text-sm">
        <button type="button" onClick={() => setMostrarModal(true)} className="text-[#0d9488] font-bold hover:underline">Esqueceu-se da password?</button>
      </div>
