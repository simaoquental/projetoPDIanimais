  ...
  return (
    <div className="min-h-screen w-full bg-[#f8fafc] flex flex-col items-center pt-12 px-6">
      ...
      <div className="flex flex-col items-center mb-10 text-center">
        ...
        <h1 className="text-4xl font-bold text-[#134e4a] tracking-tight mb-2">PawLife</h1>
        ...
        <form onSubmit={handleRegister} className="flex flex-col gap-6">
          <div className="flex flex-col gap-2">
            ...
            <div className="relative h-12">
              ...
              <input type="text" placeholder="Matilde Coimbra" className="w-full h-full bg-[#f8fafc] border border-slate-200 rounded-xl pl-12 pr-4 focus:outline-none focus:ring-2 focus:ring-[#14b8a6] transition-all" />
            </div>
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="relative h-12">
              ...
              <input type="email" placeholder="matildecoimbra@gmail.com" className="w-full h-full bg-[#f8fafc] border border-slate-200 rounded-xl pl-12 pr-4 focus:outline-none focus:ring-2 focus:ring-[#14b8a6] transition-all" />
            </div>
          </div>
